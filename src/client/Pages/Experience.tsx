                    ...
                    <section className="row">
                        <article className="col">
                            ...
                            <ul className="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" id="profile-tab2" data-toggle="tab" href="#profile2" role="tab" aria-controls="profile2" aria-selected="false">Auburn University</a>
                                </li>
                            </ul>
                            <div className="tab-content" id="myTabContent">
                                ...
                                <div className="tab-pane fade" id="profile2" role="tabpanel" aria-labelledby="profile-tab2">
                                    <div className="card m-2">
                                        <div className="card-body shadow">
                                            <h2 className="card-title">Auburn University</h2>
                                            <h4>Master of Science in Computer Science</h4>
                                            <p>Auburn, AL (2020 - Current)</p>
                                            <ul>
                                                <li>After completing Covalence bootcamp I decicded I wanted to further my knowledge and obtain a degree in Computer Science</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>

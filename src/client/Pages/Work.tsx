                    ...
                    <section className="col-10 ml-4 justify-content-center">
                        <div className="card shadow justify-content-center mb-5">
                            <div className="card-body">
                                ...
                                <p className="text-center"><span className="badge badge-dark mx-1">React</span><span className="badge badge-dark mx-1">Node.JS</span><span className="badge badge-dark mx-1">Passport.JS</span></p>
                            </div>
                        </div>
                    </section>
                </main>
